...
const CheckoutForm = () => {
  ...
  const createPaymentIntent = async () => {
    try {
      const { data } = await axios.post('/.netlify/functions/create-payment-intent', JSON.stringify({ shipping_fee, total_amount }));
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} id='payment-form'>
        ...
        <p className={succeeded ? 'result-message' : 'result-message hidden'}>
          Payment succeeded, see the result in your <a href={`https://dsahboard.stripe.com/test/payments`}>Stripe dashboard. </a>
